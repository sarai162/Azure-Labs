...
Create a new IAM role for Lambda and attach the basic Lambda execution permissions.
Go to AWS Lambda and choose Create function.
Create a new function with the required name.
Select Python as the runtime.
Assign the IAM role you created to the function.
Edit the function code so it returns the required message in the response body.
Set the response status code to 200.
Save and deploy the function.
Test the function to confirm it runs successfully and returns the expected output.
